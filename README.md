...
|                      [Device Specs API](https://rapidapi.com/controller2042000/api/gsmarenaparser)       | Clean, normalized mobile device specifications and chipsets in structured JSON format               |    `apiKey`     |  Yes  |   Yes   |
