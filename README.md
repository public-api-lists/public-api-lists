...
| [Liminal Funding-Arb Signals](https://rapidapi.com/liminal-labs/api/yieldbase-funding-arb-signals) | Ranked cross-venue crypto funding-rate arbitrage signals, annualized | `apiKey` | Yes | Yes |
| [Liminal Perp Basis APR](https://rapidapi.com/liminal-labs/api/perp-basis-apr-spot-perp-spread-funding-carry) | Spot-perp basis and funding carry APR for 900+ perpetual futures | `apiKey` | Yes | Yes |
| [Liminal Stablecoin Yield Index](https://rapidapi.com/liminal-labs/api/stablecoin-yield-index-aave-spark-compound-apy) | USDC/USDT/DAI supply yields read on-chain from Aave, Spark and Compound | `apiKey` | Yes | Yes |
