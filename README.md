...
|           [Frostbyte Wallet](https://frostbyte-landing.vercel.app)           | Multi-chain wallet API for AI agents — create wallets, check balances, swap tokens across 9 blockchains                            | `apiKey` |  Yes  |   Yes   |
