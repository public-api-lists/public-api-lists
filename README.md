...
| [DomainIntel](https://domainintel.onrender.com) | Real-time domain intelligence — RDAP, DNS over HTTPS, Certificate Transparency (crt.sh), and bulk domain lookups | `apiKey` |  Yes  |   Yes   |
