...
| [TranscriptFetch](https://transcriptfetch.com) | Timestamped video transcripts from YouTube, TikTok, Instagram, X and Facebook, with speech recognition when captions are absent. Server-side use, requests carry a secret bearer token | `apiKey` | Yes | No |
